...
const CartTab = () => {
    ...
    return (
        <div
            className={`fixed top-0 right-0 bg-gray-700 shadow-2xl h-full grid grid-rows-[auto_1fr_auto]
            transform transition-transform duration-500
            w-full sm:w-96 md:w-128 lg:w-1/3 xl:w-1/4
        ...
        >
            ...
            <div className='p-5 bg-gray-800 text-white'>
                ...
                <div className='mb-4'>
                    <div className='flex flex-col sm:flex-row mb-2'>
                        <input
                            ...
                            className='p-2 text-black w-full sm:w-1/2'
                        />
                        <select
                            value={discountType}
                            onChange={(e) => setDiscountType(e.target.value)}
                            className='p-2 text-black w-full sm:w-1/4 mt-2 sm:mt-0 sm:ml-2'
                        >
                        ...
                        <button
                            ...
                            className='bg-blue-500 p-2 mt-2 sm:mt-0 sm:ml-2 w-full sm:w-1/4'
                        >
                            Apply
                        </button>
                    </div>
                ...
                <div className='grid grid-cols-2 gap-2'>
                    ...
                    <button
                        className='bg-amber-600 text-white p-2'
